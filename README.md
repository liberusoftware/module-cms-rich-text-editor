...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-cms-rich-text-editor?sort=semver)](https://github.com/liberusoftware/module-cms-rich-text-editor/releases/latest) [![Tests](https://github.com/liberusoftware/module-cms-rich-text-editor/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-cms-rich-text-editor/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-cms-rich-text-editor
```
...
<a href="https://github.com/liberusoftware/module-cms-rich-text-editor/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-cms-rich-text-editor" alt="Contributors to liberusoftware/module-cms-rich-text-editor">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-cms-rich-text-editor/graphs/contributors).
